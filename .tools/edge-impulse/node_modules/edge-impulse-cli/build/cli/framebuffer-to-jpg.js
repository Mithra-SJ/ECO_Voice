...
const packageVersion = JSON.parse(node_fs_1.default.readFileSync(node_path_1.default.join(__dirname, '..', '..', 'package.json'), 'utf-8')).version;
commander_1.default
    ...
    .parse(process.argv);
const frameBuffer = commander_1.default.framebuffer;
const frameBufferFile = commander_1.default.framebufferFile;
const width = Number(commander_1.default.width);
const height = Number(commander_1.default.height);
const outputFile = commander_1.default.outputFile;
(() => {
    ...
    if (frameBufferFile && !node_fs_1.default.existsSync(frameBufferFile)) {
    ...
    const s = frameBufferFile ? node_fs_1.default.readFileSync(frameBufferFile, 'utf-8') : (frameBuffer || '');
    let snapshot;
    ...
    node_fs_1.default.writeFileSync(outputFile, jpegImageData.data);
    console.log('Written to', outputFile);
    return;
})();
//# sourceMappingURL=framebuffer-to-jpg.js.map