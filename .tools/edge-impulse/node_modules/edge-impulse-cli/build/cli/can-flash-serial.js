...
exports.canFlashSerial = void 0;
const serial_connector_1 = require("./serial-connector");
const SERIAL_PREFIX = '\x1b[33m[SER]\x1b[0m';
async function canFlashSerial(deviceId) {
    let device = (await serial_connector_1.SerialConnector.list()).find(d => d.path === deviceId);
    if (!device) {
...
exports.canFlashSerial = canFlashSerial;
//# sourceMappingURL=can-flash-serial.js.map