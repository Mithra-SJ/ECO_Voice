...
async function default_1(config) {
    const packageJson = (JSON.parse(await (0, promises_1.readFile)((0, path_1.join)(__dirname, '..', '..', 'package.json'), 'utf-8')));
    ...
    let pkg = await npm_registry_fetch_1.default.json(`/${packageJson.name}/`, { timeout: 3000 });
    if (pkg) {
...
//# sourceMappingURL=check-new-version.js.map