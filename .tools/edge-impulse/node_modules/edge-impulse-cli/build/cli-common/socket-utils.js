...
exports.startEio3Interceptor = exports.DEFAULT_SOCKET_IO_V2_PARAMS = void 0;
...
exports.DEFAULT_SOCKET_IO_V2_PARAMS = {
    cors: {
        origin: '*',
        methods: ['GET', 'POST'],
        credentials: true
...
function startEio3Interceptor(io) {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access
    io.engine.on('packet', (packet, engineSocket) => {
        if (typeof packet.data === 'string') {
            ...
            if (packet.data.startsWith(MESSAGE_EVENT)) {
                try {
                    const parsed = JSON.parse(packet.data.slice(2));
...
exports.startEio3Interceptor = startEio3Interceptor;
