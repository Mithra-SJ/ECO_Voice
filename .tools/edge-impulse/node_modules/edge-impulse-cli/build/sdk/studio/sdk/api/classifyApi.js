...
// ===============================================
var ClassifyApiApiKeys;
(function (ClassifyApiApiKeys) {
    ClassifyApiApiKeys[ClassifyApiApiKeys["ApiKeyAuthentication"] = 0] = "ApiKeyAuthentication";
    ClassifyApiApiKeys[ClassifyApiApiKeys["JWTAuthentication"] = 1] = "JWTAuthentication";
...
class ClassifyApi {
    ...
    setApiKey(key, value) {
        this.authentications[ClassifyApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    async classifyImage(projectId, params, queryParams, options = { headers: {} }) {
     ...
     * @param truncateStructuredLabels If true, only a slice of labels will be returned for samples with multiple labels.
     */
    async classifySampleForVariants(projectId, sampleId, queryParams, options = { headers: {} }) {
        ...
        if (queryParams?.variants !== undefined) {
            localVarQueryParameters['variants'] = models_1.ObjectSerializer.serialize(queryParams.variants, "string");
        }
        if (queryParams?.impulseId !== undefined) {
            localVarQueryParameters['impulseId'] = models_1.ObjectSerializer.serialize(queryParams.impulseId, "number");
        }
     ...
     * @param impulseId Impulse ID. If this is unset then the default impulse is used.
     */
    async getClassifyMetricsAllVariants(projectId, queryParams, options = { headers: {} }) {
     ...
     * @param truncateStructuredLabels If true, only a slice of labels will be returned for samples with multiple labels.
     */
    async getSampleWindowFromCache(projectId, sampleId, windowIndex, queryParams, options = { headers: {} }) {
...
//# sourceMappingURL=classifyApi.js.map