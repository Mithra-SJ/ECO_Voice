...
exports.TestApi = exports.TestApiApiKeys = void 0;
...
(function (TestApiApiKeys) {
    TestApiApiKeys[TestApiApiKeys["ApiKeyAuthentication"] = 0] = "ApiKeyAuthentication";
    TestApiApiKeys[TestApiApiKeys["JWTAuthentication"] = 1] = "JWTAuthentication";
    TestApiApiKeys[TestApiApiKeys["JWTHttpHeaderAuthentication"] = 2] = "JWTHttpHeaderAuthentication";
...
class TestApi {
     ...
     */
    async testAddMockModelMonitoringData(projectId, testAddMockModelMonitoringDataRequest, options = { headers: {} }) {
        ...
        localVarRequestOptions.body = JSON.stringify(models_1.ObjectSerializer.serialize(testAddMockModelMonitoringDataRequest, "TestAddMockModelMonitoringDataRequest"));
     ...
     * @param zip
     */
    async uploadVersionArchive(projectId, versionId, params, options = { headers: {} }) {
