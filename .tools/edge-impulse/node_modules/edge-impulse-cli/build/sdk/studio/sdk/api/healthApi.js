...
exports.HealthApi = exports.HealthApiApiKeys = void 0;
...
class HealthApi {
     ...
     */
    async apiHealth(queryParams, options = { headers: {} }) {
        ...
        if (queryParams?.requester !== undefined) {
            localVarQueryParameters['requester'] = models_1.ObjectSerializer.serialize(queryParams.requester, "string");
        }
     ...
     * @param requester Health check requester
     */
    async health(queryParams, options = { headers: {} }) {
