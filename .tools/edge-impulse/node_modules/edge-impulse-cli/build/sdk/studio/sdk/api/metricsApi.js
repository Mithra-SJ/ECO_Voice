...
class MetricsApi {
     ...
     */
    async getPublicMetrics(options = { headers: {} }) {
        ...
        return this.handleResponse(response, 'GetPublicMetricsResponse');
    }
    /**
     ...
     */
    async logAnalyticsEvent(logAnalyticsEventRequest, options = { headers: {} }) {
        ...
        localVarRequestOptions.body = JSON.stringify(models_1.ObjectSerializer.serialize(logAnalyticsEventRequest, "LogAnalyticsEventRequest"));
        let requestOptions = localVarRequestOptions;
        let url = localVarUrl;
        const authDefault = await this.authentications.default.applyToRequest(requestOptions, url);
        requestOptions = authDefault.requestOptions;
     ...
     */
    async logWebsitePageview(logWebsitePageviewRequest, options = { headers: {} }) {
        ...
        localVarRequestOptions.body = JSON.stringify(models_1.ObjectSerializer.serialize(logWebsitePageviewRequest, "LogWebsitePageviewRequest"));
        let requestOptions = localVarRequestOptions;
        let url = localVarUrl;
        const authDefault = await this.authentications.default.applyToRequest(requestOptions, url);
        requestOptions = authDefault.requestOptions;
