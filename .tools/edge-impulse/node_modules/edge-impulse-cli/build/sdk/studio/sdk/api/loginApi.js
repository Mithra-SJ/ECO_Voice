...
class LoginApi {
     ...
     */
    async getSSODomainIdPs(usernameOrEmail, options = { headers: {} }) {
        ...
        return this.handleResponse(response, 'GetSSODomainIdPsResponse');
    }
    /**
     ...
     * @param getJWTRequest
     */
    async login(getJWTRequest, options = { headers: {} }) {
        ...
        localVarRequestOptions.body = JSON.stringify(models_1.ObjectSerializer.serialize(getJWTRequest, "GetJWTRequest"));
        let requestOptions = localVarRequestOptions;
        let url = localVarUrl;
        const authDefault = await this.authentications.default.applyToRequest(requestOptions, url);
        requestOptions = authDefault.requestOptions;
        ...
        const response = await fetch(url, requestOptions);
        return this.handleResponse(response, 'GetJWTResponse');
    }
}
