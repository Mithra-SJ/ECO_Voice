...
(function (AuthApiApiKeys) {
    AuthApiApiKeys[AuthApiApiKeys["ApiKeyAuthentication"] = 0] = "ApiKeyAuthentication";
    AuthApiApiKeys[AuthApiApiKeys["JWTAuthentication"] = 1] = "JWTAuthentication";
    AuthApiApiKeys[AuthApiApiKeys["JWTHttpHeaderAuthentication"] = 2] = "JWTHttpHeaderAuthentication";
...
class AuthApi {
     ...
     */
    async discourse(queryParams, options = { headers: {} }) {
        ...
        if (queryParams?.sso !== undefined) {
            localVarQueryParameters['sso'] = models_1.ObjectSerializer.serialize(queryParams.sso, "string");
        }
        if (queryParams?.sig !== undefined) {
            localVarQueryParameters['sig'] = models_1.ObjectSerializer.serialize(queryParams.sig, "string");
        }
