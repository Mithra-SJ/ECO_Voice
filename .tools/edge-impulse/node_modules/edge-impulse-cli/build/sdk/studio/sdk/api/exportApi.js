...
(function (ExportApiApiKeys) {
    ExportApiApiKeys[ExportApiApiKeys["ApiKeyAuthentication"] = 0] = "ApiKeyAuthentication";
    ExportApiApiKeys[ExportApiApiKeys["JWTAuthentication"] = 1] = "JWTAuthentication";
    ExportApiApiKeys[ExportApiApiKeys["JWTHttpHeaderAuthentication"] = 2] = "JWTHttpHeaderAuthentication";
})(ExportApiApiKeys = exports.ExportApiApiKeys || (exports.ExportApiApiKeys = {}));
class ExportApi {
     ...
     */
    async getExportUrl(projectId, options = { headers: {} }) {
        ...
        return this.handleResponse(response, 'ExportGetUrlResponse');
    }
}
