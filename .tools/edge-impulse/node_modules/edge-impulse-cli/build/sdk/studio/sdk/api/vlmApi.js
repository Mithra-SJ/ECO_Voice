...
// ===============================================
var VlmApiApiKeys;
(function (VlmApiApiKeys) {
    VlmApiApiKeys[VlmApiApiKeys["ApiKeyAuthentication"] = 0] = "ApiKeyAuthentication";
    VlmApiApiKeys[VlmApiApiKeys["JWTAuthentication"] = 1] = "JWTAuthentication";
...
class VlmApi {
    ...
    setApiKey(key, value) {
        this.authentications[VlmApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    async getAllModels(projectId, options = { headers: {} }) {
     ...
     */
    async getModelById(projectId, modelId, options = { headers: {} }) {
     ...
     */
    async getVlmInference(projectId, learnId, queryParams, options = { headers: {} }) {
     ...
     */
    async runVlmInference(projectId, learnId, vlmInferenceRequest, options = { headers: {} }) {
     ...
     * @param modelId The ID of the VLM model to retrieve
     */
    async warmUpVlmModel(projectId, modelId, options = { headers: {} }) {
...
//# sourceMappingURL=vlmApi.js.map