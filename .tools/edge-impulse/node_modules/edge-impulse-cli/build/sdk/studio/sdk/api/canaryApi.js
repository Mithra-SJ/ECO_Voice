...
exports.CanaryApi = exports.CanaryApiApiKeys = void 0;
...
// ===============================================
var CanaryApiApiKeys;
(function (CanaryApiApiKeys) {
    CanaryApiApiKeys[CanaryApiApiKeys["JWTAuthentication"] = 0] = "JWTAuthentication";
})(CanaryApiApiKeys = exports.CanaryApiApiKeys || (exports.CanaryApiApiKeys = {}));
class CanaryApi {
    ...
    setApiKey(key, value) {
        this.authentications[CanaryApiApiKeys[key]].apiKey = value;
    }
    /**
     ...
     */
    async shouldGoOnCanary(queryParams, options = { headers: {} }) {
        ...
        if (queryParams?.requestedUrl !== undefined) {
            localVarQueryParameters['requestedUrl'] = models_1.ObjectSerializer.serialize(queryParams.requestedUrl, "string");
        }
        ...
        return this.handleResponse(response, 'CanaryResponse');
    }
}
exports.CanaryApi = CanaryApi;
//# sourceMappingURL=canaryApi.js.map